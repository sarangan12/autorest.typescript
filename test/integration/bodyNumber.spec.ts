...
describe("Integration tests for BodyInteger", () => {
  ...
  it("should put big float", async () => {
    await testClient.number.putBigFloat(3.402823e20, defaultOptions);
  });

  it("should put big double", async () => {
    await testClient.number.putBigDouble(2.5976931e101, defaultOptions);
  });
  ...
  it("should put small float", async () => {
    await testClient.number.putSmallFloat(3.402823e-20, defaultOptions);
  });

  it("should put small double values", async () => {
    await testClient.number.putSmallDouble(2.5976931e-101, defaultOptions);
  });
  ...
  it("should put big positive double value", async () => {
    await testClient.number.putBigDoublePositiveDecimal(defaultOptions);
  });

  it("should put big negative double value", async () => {
    await testClient.number.putBigDoubleNegativeDecimal(defaultOptions);
  });
