...
export class BodyStringClientContext extends coreClient.ServiceClient {
  $host: string;
  ...
  constructor(options?: BodyStringClientOptionalParams) {
    ...
    const userAgentPrefix =
      options.userAgentOptions && options.userAgentOptions.userAgentPrefix
        ? `${options.userAgentOptions.userAgentPrefix} body-string/1.0.0-preview1`
        : `body-string/1.0.0-preview1`;
