...
export class BodyBooleanQuirksClientContext extends coreClient.ServiceClient {
  $host: string;
  ...
  constructor(options?: BodyBooleanQuirksClientOptionalParams) {
    ...
    const userAgentPrefix =
      options.userAgentOptions && options.userAgentOptions.userAgentPrefix
        ? `${options.userAgentOptions.userAgentPrefix} body-boolean-quirks/1.0.0-preview1`
        : `body-boolean-quirks/1.0.0-preview1`;
