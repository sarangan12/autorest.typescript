...
export class BodyDateClientContext extends coreClient.ServiceClient {
  $host: string;
  ...
  constructor(options?: BodyDateClientOptionalParams) {
    ...
    const userAgentPrefix =
      options.userAgentOptions && options.userAgentOptions.userAgentPrefix
        ? `${options.userAgentOptions.userAgentPrefix} body-date/1.0.0-preview1`
        : `body-date/1.0.0-preview1`;
