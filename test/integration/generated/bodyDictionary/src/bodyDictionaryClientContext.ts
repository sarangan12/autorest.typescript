...
export class BodyDictionaryClientContext extends coreClient.ServiceClient {
  $host: string;
  ...
  constructor(options?: BodyDictionaryClientOptionalParams) {
    ...
    const userAgentPrefix =
      options.userAgentOptions && options.userAgentOptions.userAgentPrefix
        ? `${options.userAgentOptions.userAgentPrefix} body-dictionary/1.0.0-preview1`
        : `body-dictionary/1.0.0-preview1`;
