...
export class BodyTimeClientContext extends coreClient.ServiceClient {
  $host: string;
  ...
  constructor(options?: BodyTimeClientOptionalParams) {
    ...
    const userAgentPrefix =
      options.userAgentOptions && options.userAgentOptions.userAgentPrefix
        ? `${options.userAgentOptions.userAgentPrefix} body-time/1.0.0-preview1`
        : `body-time/1.0.0-preview1`;
